...
//    UIViewController *controller = [EBForeNotification appRootViewController];
    ...
    [appDelegate.window bringSubviewToFront:SharedBannerView];
}

+(UIViewController *)appRootViewController{
  NSLog(@"appDelegate.window.rootViewController=%@",appDelegate.window.rootViewController);
  UIViewController *appRootVC = appDelegate.window.rootViewController;//[UIApplication sharedApplication].keyWindow.rootViewController;
