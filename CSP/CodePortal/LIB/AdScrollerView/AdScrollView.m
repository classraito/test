...
- (void)setImageNameArray:(NSArray *)imageNameArray
{
  ...
  [_leftImageView sd_setImageWithURL:[NSURL URLWithString:_imageNameArray[0]] placeholderImage:IMG_PLACEHOLDER];//[UIImage imageNamed:_imageNameArray[0]];
  [_centerImageView sd_setImageWithURL:[NSURL URLWithString:_imageNameArray[1]] placeholderImage:IMG_PLACEHOLDER];//[UIImage imageNamed:_imageNameArray[1]];
  [_rightImageView sd_setImageWithURL:[NSURL URLWithString:_imageNameArray[2]] placeholderImage:IMG_PLACEHOLDER];//[UIImage imageNamed:_imageNameArray[2]];
}
...
//    _leftImageView.image = [UIImage imageNamed:_imageNameArray[(currentImage-1)%_imageNameArray.count]];
  [_leftImageView sd_setImageWithURL:[NSURL URLWithString:_imageNameArray[(currentImage-1)%_imageNameArray.count]] placeholderImage:IMG_PLACEHOLDER];
...
//    _centerImageView.image = [UIImage imageNamed:_imageNameArray[currentImage%_imageNameArray.count]];
    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:_imageNameArray[currentImage%_imageNameArray.count]] placeholderImage:IMG_PLACEHOLDER];
...
//    _rightImageView.image = [UIImage imageNamed:_imageNameArray[(currentImage+1)%_imageNameArray.count]];
   [_rightImageView sd_setImageWithURL:[NSURL URLWithString:_imageNameArray[(currentImage+1)%_imageNameArray.count]] placeholderImage:IMG_PLACEHOLDER];
