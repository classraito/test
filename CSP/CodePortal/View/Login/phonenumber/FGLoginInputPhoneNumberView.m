...
#import "FGLoginInputPhoneNumberView.h"

@implementation FGLoginInputPhoneNumberView
...
-(void)awakeFromNib
{
  ...
  lb_title.text = multiLanguage(@"Please key in your phone number");
