...
//static NSString *EBBannerViewTimeText = multiLanguage(@"Now");    //默认弹窗时间 default banner time
...
-(void)setUserInfo:(NSDictionary *)userInfo{
  ...
  self.time_label.text = multiLanguage(@"Now");//EBBannerViewTimeText;
...
//        for (UIWindow *window in [[UIApplication sharedApplication] windows]) {
      for (UIWindow *window in appDelegate.window.subviews) {
