...
- (CGImageRef)newCGImageByFilteringCGImageSyc:(CGImageRef)imageToFilter;
{
  GPUImageFramebuffer* framebuffer = [self framebufferForOutput];
  CGImageRef processedImage = [framebuffer newCGImageFromFramebufferContents];
...
- (UIImage *)imageByFilteringImageSyc:(UIImage *)imageToFilter;
{
  CGImageRef image = [self newCGImageByFilteringCGImageSyc:[imageToFilter CGImage]];
  UIImage *processedImage = [UIImage imageWithCGImage:image scale:[imageToFilter scale] orientation:[imageToFilter imageOrientation]];
  CGImageRelease(image);
  return processedImage;
}
