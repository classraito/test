...
@property (nonatomic, assign) BOOL isAheadInitImages;
@property (nonatomic, strong) NSMutableArray *localizationImagesGroup;
//////////////////////  滚动控制接口 //////////////////////
...
/** block方式监听点击 */
@property (nonatomic, copy) void (^clickItemOperationBlock)
    (NSInteger currentIndex);

/** block方式监听滚动 */
@property (nonatomic, copy) void (^itemDidScrollOperationBlock)
    (NSInteger currentIndex);
...
@property (nonatomic, assign)
    SDCycleScrollViewPageContolAliment pageControlAliment;
